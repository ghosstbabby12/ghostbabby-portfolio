        ...
        {selectedGame === "none" ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 animate-fadeIn">
            ...
            >
              {/* Pantalla CRT */}
              <div
                className="relative m-3 sm:m-4 md:m-6 rounded-xl md:rounded-2xl overflow-hidden border-2 sm:border-3 md:border-4 border-gray-900"
                style={{
                  aspectRatio: "4/3",
              ...
              >
                ...
                <div className="absolute top-2 sm:top-3 md:top-4 left-2 sm:left-3 md:left-4 flex items-center gap-1 sm:gap-2 z-20">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-red-500 rounded-full shadow-lg"></div>
                  <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-red-500 rounded-full shadow-lg"></div>
                  <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-red-500 rounded-full shadow-lg"></div>
                  <span className="ml-1 sm:ml-2 text-gray-400 text-xs sm:text-sm tracking-wider hidden sm:inline">
                    PRESS TO START
                  </span>
                </div>

                {/* Contenido del juego - responsive */}
                <div className="relative w-full h-full flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 z-30">
                  <div
                  ...
                  <h3
                    className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-400 mb-2 sm:mb-3 md:mb-4 tracking-wider"
                    style={{
                      fontFamily: "monospace",
            ...
            >
              ...
              >
                ...
                <div className="relative w-full h-full flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 z-30">
                  ...
                  <h3
                    className="text-xl sm:text-2xl md:text-3xl font-bold text-yellow-400 mb-2 sm:mb-3 md:mb-4 tracking-wider"
                    style={{
                      fontFamily: "monospace",
